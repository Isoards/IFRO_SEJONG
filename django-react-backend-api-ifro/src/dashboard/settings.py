...
import pymysql
pymysql.install_as_MySQLdb()ings for dashboard project.
...
# Cloud Run 환경에서 Cloud SQL 연결 설정
if os.getenv('MYSQL_HOST', '').startswith('/cloudsql/'):
    DATABASES['default']['HOST'] = ''
    DATABASES['default']['PORT'] = ''
    DATABASES['default']['OPTIONS']['unix_socket'] = os.getenv('MYSQL_HOST')
