#!/usr/bin/env python3
"""
서울 교차로 데이터를 올바른 좌표로 다시 가져오는 스크립트 (pyproj 없이)
"""
...
def epsg5186_to_wgs84_simple(x, y):
    """
    EPSG:5186 (한국 중부원점)을 WGS84로 변환 (근사치)
    한국 중부원점: 경도 127.5도, 위도 38.0도
    """
    ...
    try:
        ...
        for item in intersections:
            try:
                ...
                lat, lon = epsg5186_to_wgs84_simple(x_coord, y_coord)
