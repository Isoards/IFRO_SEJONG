...
자연스러운 한국어로 요약해주세요:"""
    ...
    def generate_context_answer(self, question: str, context_chunks: List[TextChunk]) -> Answer:
        ...
        try:
            ...
            # 사용된 키워드 추출 및 로깅
            used_keywords = self._extract_used_keywords(context_chunks)
            if used_keywords:
            ...
            return Answer(
                ...
                generation_time=generation_time,
                model_name=self.model_name,
                metadata={"answer_type": "context", "context_used": True, "chunks_used": len(context_chunks), "used_keywords": used_keywords}
            )
