...
class PipelineConfigManager:
    ...
    def __init__(self, config_dir: str = "config/pipelines"):
        ...
        self.project_domain = os.getenv('PROJECT_DOMAIN', '범용')
        self.project_industry = os.getenv('PROJECT_INDUSTRY', '범용')
