...
class GreetingHandler:
    ...
    def __init__(self, answer_generator=None):
        ...
        self.company_greetings = {
            "default": os.getenv("COMPANY_GREETING", "범용 RAG 시스템에 오신 것을 환영합니다! 🤖"),
            "general": os.getenv("COMPANY_GREETING", "범용 RAG 시스템에 오신 것을 환영합니다! 🤖"),
        }
    ...
    def _classify_greeting_type(self, question: str) -> str:
        ...
        # 기본값은 도움 요청으로 처리 (시스템에 대한 질문일 가능성이 높음)
        return "help"
