...
class QueryRouter:
    ...
    def route_query(self, question: str) -> RouteResult:
        ...
        greeting_keywords = self.pipeline_config_manager.get_pipeline_keywords("GREETING")
    ...
    def _rule_based_routing(self, question: str) -> RouteResult:
        ...
        greeting_patterns = [
            ...
            '처음', '처음이에요', '처음입니다', '처음 사용', '처음 사용해요',
            '도움', '도움이 필요', '도움이 필요해요', '도움이 필요합니다',
            '환영', '환영합니다', '오신 것을 환영', '환영해요',
            '시스템', '시스템이에요', '시스템입니다', '시스템이 뭐야',
            '무엇', '뭐야', '뭔가', '뭔가요', '뭔가요?', '뭐예요', '뭐예요?'
        ]
