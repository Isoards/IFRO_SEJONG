    ...
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {t("reports.volumeByDirection") || "Volumen por Dirección"}
            </h3>
          </div>
          <div style={{ padding: "16px" }}>
            <div>
              {trafficVolumes && Object.entries(trafficVolumes).length > 0 ? (
                Object.entries(trafficVolumes).map(
                  ([direction, volume], index) => (
                    <div
                      key={direction}
                      style={{
                        display: "flex",
                        ...
                        marginBottom:
                          index <
                          (trafficVolumes
                            ? Object.entries(trafficVolumes).length
                            : 0) -
                            1
                            ? "12px"
                            : "0",
        ...
        >
          ...
          >
            ...
            >
              {t("reports.summaryStatistics") || "Estadísticas Resumen"}
            </h3>
          </div>
          <div style={{ padding: "16px" }}>
            <div>
              ...
              >
                ...
                >
                  {t("reports.totalVolume") || "Volumen Total"}:
                </span>
                <span
                  style={{
                    fontSize: "20px",
              ...
              >
                ...
                >
                  {t("reports.averageSpeed") || "Velocidad Promedio"}:
                </span>
                <span
                  style={{
                    fontSize: "20px",
              ...
              {peakDirection && (
                ...
                >
                  ...
                  >
                    {t("reports.peakDirection") || "Dirección Pico"}:
                  </span>
                  <span
                    style={{
                      fontSize: "18px",
              ...
              {congestionLevel && (
                ...
                >
                  ...
                  >
                    {t("reports.congestionLevel") || "Nivel de Congestión"}:
                  </span>
                  <span
                    style={{
                      padding: "6px 12px",
      ...
      >
        ...
        >
          ...
          >
            {t("reports.trafficFlowSummary") || "Resumen de Flujo de Tráfico"}
          </h3>
        </div>
          ...
          <table style={{ width: "100%", borderCollapse: "collapse" }}>
            <thead style={{ backgroundColor: "#f3f4f6" }}>
              <tr>
                ...
                >
                  {t("reports.percentage") || "Porcentaje"}
                </th>
                <th
                  style={{
                    padding: "12px 16px",
