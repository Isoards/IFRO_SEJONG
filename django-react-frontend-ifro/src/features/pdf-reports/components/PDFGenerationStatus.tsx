...
import { PDFGenerationStatus as PDFStatus } from "../../../shared/types/global.types";
      ...
      {!hasData && (
        <FeedbackMessage
          ...
          message={
            ...
            "No traffic data available for PDF generation"
          }
          isVisible={true}
          showCloseButton={false}
        />
